...
/**
 * Created by Axyn on 22/06/2017.
 */

public class NotificationsUpdate extends WearableListenerService {
    ...
    private void sendNotification(String title, String content) {
        ...
        Intent viewIntent = new Intent(this, MainActivityWatch.class);
